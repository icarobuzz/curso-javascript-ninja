...
*/
pessoa.nomeCompleto() //"Olá! Meu nome é Icaro Rego"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso() //"Eu peso 62.2Kg."

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostraAltura() //"Minha altura é: 1.65m"
...
pessoa.apresentacao = function () {
    return "Olá, eu sou " + pessoa.nomeCompleto() + ", tenho" + pessoa.idade + " anos, " + pessoa.altura + 
